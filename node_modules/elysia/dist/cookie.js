...
this.property.secure=e,this.sync())}toString(){return"object"==typeof this.value?JSON.stringify(this.value):this.value?.toString()??""}sync(){return this.name&&this.setter&&(this.setter.cookie?this.setter.cookie[this.name]=Object.assign(this.property,{value:this.toString()}):this.setter.cookie={[this.name]:Object.assign(this.property,{value:this.toString()})}),this}}export const createCookieJar=(e,t,r)=>new Proxy(e,{get(e,i){if(i in e)return e[i];// @ts-ignore
    ...
    s.setter=t,s.name=i,s)},set:(e,r,i)=>i instanceof Cookie&&(t.cookie||(t.cookie={}),// @ts-ignore
        ...
        i.sync(),e[r]=i,!0)});export const parseCookie=(i,s,{secret:o,sign:p,...n}={})=>{if(!s)return createCookieJar({},i,n);let h={},a="string"==typeof o;p&&!0!==p&&!Array.isArray(p)&&(p=[p]);let y=Object.keys(e(s));for(let u=0;u<y.length;u++){let l=y[u],c=e(s)[l];if(!0===p||p?.includes(l)){if(!o)throw Error("No secret is provided to cookie plugin");if(a)// @ts-ignore
{if(!1===// @ts-ignore
(c=t(c,o)))throw new r(l)}else{let e=!0;for(let r=0;r<o.length;r++){let i=t(c,o[r]);if(!1!==i){c=i,e=!1;break}}if(e)throw new r(l)}}let g=c.charCodeAt(0);if(123===g||91===g)try{let e=new Cookie(JSON.parse(c));// @ts-ignore
e.setter=i,e.name=l,h[l]=e;continue}catch{// Not empty
}Number.isNaN(+c)?"true"===c?c=!0:"false"===c&&(c=!1):c=+c;let m=new Cookie(c,n);// @ts-ignore
m.setter=i,m.name=l,h[l]=m}return createCookieJar(h,i)};